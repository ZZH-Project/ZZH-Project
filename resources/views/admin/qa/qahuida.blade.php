    ...
    <div style="background: white;padding: 0 10px 25px 10px;">
        ...
        <table class="tb">
            <tr>
                ...
                <th style="border-left: 1px solid #3399ff;width: 150px;">问题内容</th>
                <th>回答内容</th>
            </tr>
                <tr class="trd">
                    <td style="border-left: 1px solid #e5e5e5;">{{$qacontent->is_show}}</td>
                    <td>{{$qacontent->contentc}}</td>
                    <td>{{$qacontent->commentc}}</td>
                </tr>
            <tr>
                <td colspan="8" style="border-left: 1px solid #e5e5e5;">
                    <a href="{{url('admin/qacomment/switch').'/'.$qacontent->id.'/'.($qacontent->is_show==1?0:1)}}"><i class="fa fa-fw fa-retweet" title="切换状态"></i></a>
                </td>
            </tr>
        </table>
    </div>
