...
@section('title','美丽联合-微圈评论')
@section('title-first','微圈评论管理')
@section('title-second','微圈评论')
@section('style')
    <link rel="stylesheet" href="{{asset('css/admin/admin_userList_zj.css')}}">
@endsection
@section('main')
    <div style="background: white;padding: 0 10px 25px 10px;">
        <h3 style="padding-top: 20px;color: #3399ff;">微圈评论列表</h3>
        <table class="tb">
            <tr>
...
@section('script')
    ...
    <script>
        $(".show").click(function () {
            ...
            $.ajax({
                url:"{{url('admin/wechatComment/is')}}/"+id,
                type:"get",
                data:{"id":id},
                dataType:"string",
